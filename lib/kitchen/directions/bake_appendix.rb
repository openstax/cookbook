...
module Kitchen
  module Directions
    module BakeAppendix
      def self.v1(page:, number:, block_target_label: false, cases: false)
        title = page.title
        title.name = 'h1'
        ...
        page.target_label(label_text: 'appendix', custom_content: "#{number} #{title_label}", cases: cases) unless block_target_label
