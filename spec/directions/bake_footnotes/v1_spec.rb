    ...
    expect(book_1.body.children.to_s).to match_normalized_html(
      <<~HTML
        <div data-type="page">
          ...
          <aside id="aside1" type="footnote"><div class="footnote-number">1</div>Footnote content 1</aside>
        </div>
        <div data-type="chapter">
          <div data-type="page">
            <p><a href="#aside2" role="doc-noteref">1</a> Blah.</p>
            <aside id="aside2" type="footnote"><div class="footnote-number">1</div>Footnote content 2</aside>
            <p><a href="#aside3" role="doc-noteref">2</a> Blah.</p>
            <aside id="aside3" type="footnote"><div class="footnote-number">2</div>Footnote content 3</aside>
          </div>
          <div data-type="page">
            <p><a href="#aside4" role="doc-noteref">3</a> Blah.</p>
            <aside id="aside4" type="footnote"><div class="footnote-number">3</div>Footnote content 4</aside>
          </div>
          <div data-type="composite-page">
