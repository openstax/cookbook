    ...
    book_containing(html:
      <<~HTML
        <div data-type="page" class="preface">
          ...
          <p class="annotation linguistic-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00056">understanding content through the broad lens of language</p>
          <p class="annotation culture-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00057">understanding content through the broad lens of culture</p>
          <p class="annotation visual-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00058">seeing to create meaning</p>
          <p class="annotation speech-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00059">voice to text</p>
          <p class="annotation auditory-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00060">listening to create meaning</p>
          <p class="annotation kinesthetic-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00061">movement to create meaning</p>
          <p class="annotation dreaming-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00062">where ideas come from and how to capture them</p>
        </div>
    ...
    expect(book1.body.children.to_s).to match_normalized_html(
      <<~HTML
        <div class="preface" data-type="page">
          ...
          <div data-type="abstract" id="abcde">abstract</div>
          <p class="annotation linguistic-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00056">
            <span class="os-icons">
              <span aria-label="Language lens icon" class="linguistic-icon" role="img" title="Language lens icon"></span>
            </span>
            <span class="os-text">understanding content through the broad lens of language</span>
          </p>
          <p class="annotation culture-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00057">
            <span class="os-icons">
              <span aria-label="Culture lens icon" class="culture-icon" role="img" title="Culture lens icon"></span>
            </span>
            <span class="os-text">understanding content through the broad lens of culture</span>
          </p>
          <p class="annotation visual-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00058">
            <span class="os-icons">
              <span aria-label="Visual learning style icon" class="visual-icon" role="img" title="Visual learning style icon"></span>
            </span>
            <span class="os-text">seeing to create meaning</span>
          </p>
          <p class="annotation speech-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00059">
            <span class="os-icons">
              <span aria-label="Voice to text icon" class="speech-icon" role="img" title="Voice to text icon"></span>
            </span>
            <span class="os-text">voice to text</span>
          </p>
          <p class="annotation auditory-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00060">
            <span class="os-icons">
              <span aria-label="Auditory learning style icon" class="auditory-icon" role="img" title="Auditory learning style icon"></span>
            </span>
            <span class="os-text">listening to create meaning</span>
          </p>
          <p class="annotation kinesthetic-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00061">
            <span class="os-icons">
              <span aria-label="Kinesthetic learning style icon" class="kinesthetic-icon" role="img" title="Kinesthetic learning style icon"></span>
            </span>
            <span class="os-text">movement to create meaning</span>
          </p>
          <p class="annotation dreaming-icon" id="auto_e4a1ea69-275c-4cda-8b96-983c9a17dcb3_para-00062">
            <span class="os-icons">
              <span aria-label="Generating and capturing ideas icon" class="dreaming-icon" role="img" title="Generating and capturing ideas icon"></span>
            </span>
            <span class="os-text">where ideas come from and how to capture them</span>
          </p>
        </div>
        <div data-type="chapter">
          <div class="chapter-content-module" data-type="page">
