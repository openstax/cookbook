...
RSpec.describe Kitchen::Directions::BakeAutotitledExercise do
  let(:exercise) do
    book_containing(html:
      one_chapter_with_one_page_containing(
        <<~HTML
          <div data-element-type="check-understanding" data-type="exercise">
  ...
  it 'bakes' do
    described_class.v2(exercise: exercise, title: 'Check Your Understanding')
  ...
  it 'works if no solution' do
    described_class.v2(exercise: exercise_no_solution, title: 'abc')
